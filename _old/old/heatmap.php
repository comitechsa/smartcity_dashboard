<?php
//https://get.smartspeech.eu/heatmap.php?child=4&iteration=0&episode=0
	//4
	//15
	$child=$_GET['child'];
	...
	/*
	https://smartspeech.ddns.net/files/beecalibration_gaze_screen_recording_2021_01_11_09_59_46_665.mp4 1152x720 2560x1600 1728x1080
	ok Episode 0: beecalibration_gaze_screen_recording_2021_01_11_09_59_46_665.mp4
	ok Episode 1: rika&bee_gaze_screen_recording_2021_01_11_10_01_49_065.mp4
	ok Episode 2: upsidedwarf_gaze_screen_recording_2021_01_11_10_03_27_400.mp4
	ok Episode 3: bizzareelements_gaze_screen_recording_2021_01_11_10_03_54_934.mp4
	Episode 8: dreamthings1_gaze_screen_recording_2021_01_11_10_06_21_089.mp4, dreamthings2_gaze_screen_recording_2021_01_11_10_08_48_036.mp4, dreamthings3_gaze_screen_recording_2021_01_11_10_09_51_533.mp4, dreamthings4_gaze_screen_recording_2021_01_11_10_10_23_682.mp4
	ok Episode 11: themisconfused_gaze_screen_recording_2021_01_11_10_20_06_134.mp4
	Episode 16: tablet_gaze_screen_recording_2021_01_11_10_22_24_699.mp4
	Episode 19: apsoucalibration_gaze_screen_recording_2021_01_11_10_28_07_805.mp4
	*/	
	...
	if($episode==0){
		...
		$video="dreamthings1_gaze_screen_recording_2021_01_11_10_06_21_089.mp4";
		$episodeFiles=(explode(";",$data[$iteration]->EpisodeData->{'Episode 08'}->Files));
		$gazeFile=$episodeFiles[0];		
	} else if($episode==82){
		$video="dreamthings2_gaze_screen_recording_2021_01_11_10_08_48_036.mp4";
		$episodeFiles=(explode(";",$data[$iteration]->EpisodeData->{'Episode 08'}->Files));
		$gazeFile=$episodeFiles[1];	
	} else if($episode==83){
		$video="dreamthings3_gaze_screen_recording_2021_01_11_10_09_51_533.mp4";
		$episodeFiles=(explode(";",$data[$iteration]->EpisodeData->{'Episode 08'}->Files));
		$gazeFile=$episodeFiles[2];	
	} else if($episode==84){
		$video="dreamthings4_gaze_screen_recording_2021_01_11_10_10_23_682.mp4";
		$episodeFiles=(explode(";",$data[$iteration]->EpisodeData->{'Episode 08'}->Files));
		$gazeFile=$episodeFiles[3];	
	} else if($episode==11){
...
//exit;
	...
	for($line=0;$line<sizeof($lines);$line++){
		if($line==0){
			...
			if(sizeof($values)==6 && $line>1){
				$datax[intval($values[5])]['lat'][]=($values[0]>0?$values[0]:0)*1080/$dimentions[0];
				$datax[intval($values[5])]['lng'][]=($values[1]>0?$values[1]:0)*675/$dimentions[1];
				//$datax[intval($values[2])]['clk'][]=intval($values[2]);
				$datax[intval($values[5])]['clk'][]=intval($values[5]);
				//SUCCESS,SACCADE,INSIDE_OF_SCREEN
			}
		}
	}
