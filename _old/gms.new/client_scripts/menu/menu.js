...
function cmDrawSubMenu (subMenu, prefix, id, nodeProperties, zIndexStart, menuInfo, menuID)
{
	...
	for (i = 5; i < subMenu.length; ++i)
	{
		...
		if (item[0] != null)
			str += '<img align="absmiddle" hspace="3" src="' + item[0] + '" />';
		else
...
function cmDraw (id, menu, orient, nodeProperties, prefix)
{
	...
	for (i = 0; i < menu.length; ++i)
	{
		...
		str += (item[0] == null) ? (hasChild ? nodeProperties.mainFolderLeft : nodeProperties.mainItemLeft) : ('<img align="absmiddle" hspace="3" src="' + item[0] + '" />');
		str += vertical ? '</td>' : '</span>';
...
var cmProperties =
{
	...
	folderLeft: '<img alt="" src="/gms/client_scripts/menu/images/spacer.png">',
	folderRight: '<img alt="" src="/gms/client_scripts/menu/images/arrow.png">',
	itemLeft: '<img alt="" src="/gms/client_scripts/menu/images/spacer.png">',
	itemRight: '<img alt="" src="/gms/client_scripts/menu/images/blank.png">',
	mainSpacing: 0,
	subSpacing: 0,
	delay: 500
};
