...
//{
	...
	{	
		...
		//[q1] => on [q2] => on [q3-1] => on [q3-3] => on [email] => )
			...
			$q3=($_POST['q3-1']=='on'?'1':'0').($_POST['q3-2']=='on'?'1':'0').($_POST['q3-3']=='on'?'1':'0').($_POST['q3-4']=='on'?'1':'0').($_POST['q3-5']=='on'?'1':'0').($_POST['q3-6']=='on'?'1':'0').($_POST['q3-7']=='on'?'1':'0').($_POST['q3-8']=='on'?'1':'0');
			$q4=($_POST['q4-1']=='on'?'1':'0').($_POST['q4-2']=='on'?'1':'0').($_POST['q4-3']=='on'?'1':'0').($_POST['q4-4']=='on'?'1':'0').($_POST['q4-5']=='on'?'1':'0').($_POST['q4-6']=='on'?'1':'0').($_POST['q4-7']=='on'?'1':'0').($_POST['q4-8']=='on'?'1':'0').($_POST['q4-9']=='on'?'1':'0').($_POST['q4-9']=='on'?'1':'0').($_POST['q4-10']=='on'?'1':'0').
			...
			($_POST['q4-51']=='on'?'1':'0').($_POST['q4-52']=='on'?'1':'0').($_POST['q4-53']=='on'?'1':'0').($_POST['q4-54']=='on'?'1':'0').($_POST['q4-55']=='on'?'1':'0');
			...
			$q72=($_POST['q72-1']=='on'?'1':'0').($_POST['q72-2']=='on'?'1':'0').($_POST['q72-3']=='on'?'1':'0').($_POST['q72-4']=='on'?'1':'0').($_POST['q72-5']=='on'?'1':'0').($_POST['q72-6']=='on'?'1':'0').($_POST['q72-7']=='on'?'1':'0').($_POST['q72-8']=='on'?'1':'0').($_POST['q72-9']=='on'?'1':'0');
			$Collector["q72"] = $q72;
			$QuotFields["q72"] = true;
			...
			$q87=($_POST['q87-1']=='on'?'1':'0').($_POST['q87-2']=='on'?'1':'0').($_POST['q87-3']=='on'?'1':'0').($_POST['q87-4']=='on'?'1':'0').($_POST['q87-5']=='on'?'1':'0').($_POST['q87-6']=='on'?'1':'0').($_POST['q87-7']=='on'?'1':'0').($_POST['q87-8']=='on'?'1':'0');
			$Collector["q87"] = $q87;
			$QuotFields["q87"] = true;			
			
			$Collector["q88"] = (intval($_POST['q88'])>0?$_POST['q88']:'');
			$QuotFields["q88"] = true;	
			...
			$q153=($_POST['q153-1']=='on'?'1':'0').($_POST['q153-2']=='on'?'1':'0').($_POST['q153-3']=='on'?'1':'0').($_POST['q153-4']=='on'?'1':'0').($_POST['q153-5']=='on'?'1':'0').($_POST['q153-6']=='on'?'1':'0').($_POST['q153-7']=='on'?'1':'0').($_POST['q153-8']=='on'?'1':'0');
			$Collector["q153"] = $q153;
			$QuotFields["q153"] = true;	

			$Collector["q154"] = (intval($_POST['q154'])>0?$_POST['q154']:'');
			...
			$q163=($_POST['q163-1']=='on'?'1':'0').($_POST['q163-2']=='on'?'1':'0').($_POST['q163-3']=='on'?'1':'0').($_POST['q163-4']=='on'?'1':'0').($_POST['q163-5']=='on'?'1':'0').($_POST['q163-6']=='on'?'1':'0').($_POST['q163-7']=='on'?'1':'0').($_POST['q163-8']=='on'?'1':'0');
			$Collector["q163"] = $q163;
			$QuotFields["q163"] = true;	
			
			$q164=($_POST['q164-1']=='on'?'1':'0').($_POST['q164-2']=='on'?'1':'0').($_POST['q164-3']=='on'?'1':'0').($_POST['q164-4']=='on'?'1':'0').($_POST['q164-5']=='on'?'1':'0');
			$Collector["q164"] = $q163;
			$QuotFields["q164"] = true;	
			
			$Collector["q165"] = (intval($_POST['q165'])>0?$_POST['q165']:'');
					...
					<!--
								...
								<div class="form-group">
									<div class="form-group">
									   ...
									   <div class="input-group date" id="birthdate" data-target-input="nearest">
											<input type="text" name="birthdate" id="birthdate" class="form-control datetimepicker-input" data-target="#birthdate" value="<?=(isset($dr_e["birthdate"]) ? $dr_e["birthdate"]:'')?>"/>
						...
						*/
						...
						<div class="form-group row" style="margin-top:20px;">
							...
							<a href="index.php?com=children"><button type="button" class="btn btn-primary">Επιστροφή</button></a>
						</div>
					</div>
				</div>
			</section>
		...
		<div class="col">
			<section class="card form-wizard" id="w4">
				<header class="card-header">
					...
					<h2 class="card-title">Δημογραφικά</h2>
				</header>
				<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="radio-custom radio-primary">
										...
										<label for="q1-1">κανονικό σχολείο</label>
									</div>
									<div class="radio-custom radio-primary">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="radio-custom radio-primary">
										...
										<label for="q2-1">κανονική (συνεπής)</label>
									</div>
									<div class="radio-custom radio-primary">
						...
						<div id="w4-4" class="tab-pane">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									...
									<div class="radio-custom radio-primary">
										<input type="radio" id="q6-2" value='2' <?=($dr_e['q6']=='1'?'checked':'')?> name="q6">
										<label for="q6-2">Φυσιολογικό</label>
									</div>
									<div class="radio-custom radio-primary">
										<input type="radio" id="q6-3" value='3' <?=($dr_e['q6']=='1'?'checked':'')?> name="q6">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="checkbox-custom checkbox-default">
										...
										<label for="q72-1">εκφράζει στο πρόσωπό του τα ανάλογα συναισθήματα (π.χ. γέλιο, κλάμα, θυμό, …);</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-2" <?=(substr($dr_e['q72'],1,1)=='1'?'checked':'')?> name="q72-2">
										<label for="q72-2">δεν εκφράζει στο πρόσωπό του τα ανάλογα συναισθήματα</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-3" <?=(substr($dr_e['q72'],2,1)=='1'?'checked':'')?> name="q72-3">
										<label for="q72-3">έχει αδικαιολόγητες κρίσεις θυμού</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox" id="q72-4" <?=(substr($dr_e['q72'],3,1)=='1'?'checked':'')?> name="q72-4">
										<label for="q72-4">έχει αδικαιολόγητο ενθουσιασμό</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-5" <?=(substr($dr_e['q72'],4,1)=='1'?'checked':'')?> name="q72-5">
										<label for="q72-5">έχει επιθετικές τάσεις</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-6" <?=(substr($dr_e['q72'],5,1)=='1'?'checked':'')?> name="q72-6">
										<label for="q72-6">παρουσιάζει υποταγή / απόσυρση</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-7" <?=(substr($dr_e['q72'],6,1)=='1'?'checked':'')?> name="q72-7">
										<label for="q72-7">ψυχολογικές μεταπτώσεις</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-8" <?=(substr($dr_e['q72'],7,1)=='1'?'checked':'')?> name="q72-8">
										<label for="q72-8">υπερβολικά ντροπαλό</label>
									</div>
									<div class="checkbox-custom checkbox-default">
										<input type="checkbox"  id="q72-9" <?=(substr($dr_e['q72'],7,1)=='1'?'checked':'')?> name="q72-9">
										<label for="q72-9">ΔΕΝ ΤΑΙΡΙΑΖΕΙ</label>
									</div>
								</div>
							</div>
							<hr>
								...
								while ($dr = $db->sql_fetchrow($result))
								{
									?>
										<tr>
											...
											<td>
												<select class="form-control" name='editOption' id='editOption'  onchange="changeURL(<?=$dr["children_id"]?>)">
													<option>Επιλογή</option>
													<option value="0">Γενικά στοιχεία</option>
													<option value="1">Δημογραφικά στοιχεία</option>
													<option value="2">Λεκτικές επικοινωνιακές εκφάνσεις</option>
													<option value="3">Μη λεκτικές επικοινωνιακές εκφάνσεις</option>
													<option value="4">Στοματοπροσωπικός Έλεγχος/Ποιοτικά Στοιχεία Ομιλίας</option>
													<option value="5">Άρθρωση/ Φωνολογία</option>
													<option value="6">Έκφραση της Γλώσσας</option>
													<option value="7">Ψυχοκινητική Ανάπτυξη</option>
													<option value="8">Ακουστική Κατανόηση</option>
													<option value="9">Μνήμη</option>
												</select>
											</td>
											<td>
												<!-- <a style="padding:4px"  href="index.php?com=children&Command=edit&item=<?=$dr["children_id"]?>"><i class="fas fa-edit"></i> Επεξεργασία</a>-->
												<a style="padding:4px"  href="#" id="editLink"><i class="fas fa-edit"></i> Επεξεργασία</a>
...
function changeURL(id,option){
	...
	var e = document.getElementById("editOption");
	...
	console.log(new_url);
    document.getElementById("editLink").href=new_url; 
    return false;
}
