...
$command=explode("&",$_POST["Command"]);
	...
	{	
		if($_REQUEST["Command"] == "SAVE")
		{
			...
			$Collector["color_short"] = $_POST["color_short"];
			$QuotFields["color_short"] = true;
			
			$Collector["color_long"] = $_POST["color_long"];
			$QuotFields["color_long"] = true;
			...
			if($item != "")
			{
				...
				$db->sql_query("DELETE FROM ads WHERE ads_id=" . $item);
	...
	<div class="row-fluid"> 
		<div class="span12">            
			...
			<div class="box-content nopadding">
				...
				<div class="controls">
					<span class="help-block">Χρώμα τίτλου</span>
					<div class="input-append color colorpick" data-color="<?=(isset($dr_e["color_title"]) ? $dr_e["color_title"] : "#000000")?>)" data-color-format="hex">
						<input type="text" class="span12" name="color_title" value="<?=(isset($dr_e["color_title"]) ? $dr_e["color_title"] : "#000000")?>">
						<span class="add-on"><i style="background-color: <?=(isset($dr_e["color_title"]) ? $dr_e["color_title"] : "#000000")?>;"></i></span>
					</div>
				</div>

				<div class="controls">
					<span class="help-block">Χρώμα σύνοψης</span>
					<div class="input-append color colorpick" data-color="<?=(isset($dr_e["color_short"]) ? $dr_e["color_short"] : "#000000")?>)" data-color-format="hex">
						<input type="text" class="span12" name="color_short" value="<?=(isset($dr_e["color_short"]) ? $dr_e["color_short"] : "#000000")?>">
						<span class="add-on"><i style="background-color: <?=(isset($dr_e["color_short"]) ? $dr_e["color_short"] : "#000000")?>;"></i></span>
					</div>
				</div>
				

				<div class="controls">
					<span class="help-block">Χρώμα περιγραφής</span>
					<div class="input-append color colorpick" data-color="<?=(isset($dr_e["color_long"]) ? $dr_e["color_long"] : "#000000")?>)" data-color-format="hex">
						<input type="text" class="span12" name="color_long" value="<?=(isset($dr_e["color_long"]) ? $dr_e["color_long"] : "#000000")?>">
						<span class="add-on"><i style="background-color: <?=(isset($dr_e["color_long"]) ? $dr_e["color_long"] : "#000000")?>;"></i></span>
					</div>
				</div>
				<!--
				<div class="control-group">
                        ...
                        while ($dr = $db->sql_fetchrow($result))
                        {
                            ...
                            ?>
                                <tr>
									...
									<td><?=$dr["hits"]?></td>
                                    <td>
                                        <a style="padding:4px"  href="index.php?com=ads&Command=edit&item=<?=$dr["ads_id"]?>"><i class="icon-edit"></i> <?=edit?></a>
                                        <a href="#" onclick="ConfirmDelete('<?=deleteConfirm?>','index.php?com=ads&Command=DELETE&item=<?=$dr["ads_id"]?>');"><span><i class="icon-trash"></i><?=delete?></a></span></a>
                                    </td>
                                </tr>
                            <?
                        }
