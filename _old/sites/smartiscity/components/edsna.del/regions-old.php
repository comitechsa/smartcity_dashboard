...
if(isset($_GET["item"])) {
	...
	<div class="row-fluid"> 
		<div class="span12">            
			...
			<div class="box-content nopadding">
				...
				<div class="control-group">
					<div class="controls">
						...
						<input type="text" name="region_name" id="region_name" required class="input-xxlarge valid" data-rule-minlength="2" data-rule-required="true" <?=(isset($dr_e["region_name"]) ? 'value="'.$dr_e['region_name'].'"' : "")?> >
					</div>
				</div>
			...
			<a href="index.php?com=regions"><button type="button" class="btn btn-primary"><?=pageReturn?></button></a>
    </div>
