				...
				<div id="add-listing" class="separated-form">
					...
					<div class="add-listing-section">
						...
						<div class="add-listing-headline">
							<h3 style="font-family: 'Commissioner', sans-serif;"><i class="sl sl-icon-doc"></i> Περιοχές</h3>
						</div>
						...
						<div class="row with-forms">
							<div class="col-md-12">
								<label for="region_name">Ονομασία περιοχής</label>
							...
							while ($dr = $db->sql_fetchrow($result))
							{
								?>
									...
									<tr>
										...
										<td>
											<a style="padding:4px"  href="index.php?com=regions&Command=edit&item=<?=$dr["region_id"]?>"><span style="font-size:22px;" class="im im-icon-File-Edit"></span> </a>
											<a href="#" onclick="ConfirmDelete('<?=deleteConfirm?>','index.php?com=regions&Command=DELETE&item=<?=$dr["region_id"]?>');"><span  style="font-size:22px;" class="im im-icon-Delete-File"></span> </a></a>
										</td>
									</tr>
								<?
							}
