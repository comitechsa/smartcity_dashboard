							...
							<div class="nano-content" style="position:inherit;">
								<ul id="" class="list-unstyled">
									...
									$filter="";
										...
										WHERE t1.is_valid='True' ORDER BY t1.date_insert DESC ";
										$result = $db->sql_query($query);
										$counter = 0;
										while ($dr = $db->sql_fetchrow($result))
										{
									?>
										<li style="font-size:12px;">
											<a href="index.php>com=notificationlist?item=<?=$dr['notification_id']?>">
												...
												<div class="col-mail">
													<p class="m-0 mail-content">
														<span class="subject"><?=$dr['title']?></span>
													</p>
													<!-- <i class="mail-attachment fas fa-paperclip"></i> -->
													
													<p class="m-0 mail-date"><?=$dr['date_read']?></p>
												</div>
											</a>
										</li>
									<? } ?>
