					...
					<table class="table table-hover table-nomargin dataTable dataTable-columnfilter table-bordered">
						...
						<tbody>
							<?
								...
								$query = "SELECT t1.*,t2.name FROM bin_types t1 INNER JOIN municipalities t2 ON t1.municipality_id=t2.municipality_id WHERE 1=1  " . $filter . " ORDER BY t1.description ";
