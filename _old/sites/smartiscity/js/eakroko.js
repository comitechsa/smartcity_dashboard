	...
	if($('.plupload').length > 0){
		$(".plupload").each(function(){
			...
			$el.pluploadQueue({
				...
				url : 'index.php?com=messages&c='+getParameter("c")+'&item='+getParameter("item")+'&up=true',
				max_file_size : '10mb',
				chunk_size : '1mb',
				unique_names : true,
			...
			if(true || $el.hasClass("pl-sidebar")){
		...
		$('.dataTable').each(function(){
			if(!$(this).hasClass("dataTable-custom")) {
				...
				if($(this).hasClass("dataTable-scroller")){
					...
					//opt.sAjaxSource = "http://localhost/jimemail/sites/jimemail/js/plugins/datatable/demo.txt";
					//opt.sAjaxSource = "http://panel.spotyy.com/demo.txt";
					opt.sAjaxSource = "http://panel.spotyy.com/index.php?com=friendsJSON";
				}
